...
const SkillsMarquee = () => {
    const generateRandomSymbols = () => {
        const text = 'Anime Lover - May Be Funny - Animation Enthusiast - '
    ...
    return (
        <section className="Skills_marquee">
            <Marquee speed={30} className='marquee2' direction='left' background={2}>
                <MotionDiv from={{ transform: `translateY(100%)` }} to={{ transform: `translateY(0)` }} duration={1000} scrollDiv={true} offsetTop={40} offsetBottom={-10} reverse={false}>
                    <div className='marquee_item dim' >
            ...
            <Marquee speed={50} className='marquee1' background={1} direction='right'>
                <MotionDiv from={{ transform: `translateY(100%)` }} to={{ transform: `translateY(0)` }} scrollDiv={true} offsetTop={40} offsetBottom={-10}  >
