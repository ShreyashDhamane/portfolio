    ...
    <div className="Experience container">
      <div className="title_wrapper">
        <MotionDiv
          ...
          reverse={false}
        >
          <h2>Research Projects with Publications</h2>
        </MotionDiv>
      </div>

      <div
        className={`work_wrapper ${enteredExperience ? "active" : ""}`}
        onMouseLeave={() => {
        ...
        {experiences.map((experience, index) => {
          return (
            <div
              ...
              onMouseEnter={() => {
                setCurrMouseEntered(index);
              }}
            >
              <div
                className={`work_cursor ${
                  cursorActive &&
                  currMouseEntered === index &&
                  activeIndex !== index
                    ? "active"
                    : ""
                }`}
              >
                <img
                  ...
                  alt=""
                  style={{
                    padding: `${experience.padding ? experience.padding : 0}`,
                  }}
                />
              ...
              >
                <div className="company_wrapper">
                  <div
                    className={`company ${enteredExperience ? "active" : ""}`}
                  >
                    {experience.company}
                  </div>
                </div>
                <div className="role_wrapper">
                  <div className={`role ${enteredExperience ? "active" : ""}`}>
                    {experience.role}
                  </div>
                </div>
              </div>
